 ...
 * @author cc
 */
public class HibernateDaoNew<T, PK extends Serializable> extends HibernateGenericDaoNew<T, PK>
	 ...
	 * 
	 */
	public HibernateDaoNew(final SessionFactory sessionFactory, final Class<T> entityClass) {
